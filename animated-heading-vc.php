 ...
 * Plugin URI: https://github.com/sajjadh47/Animated-Headline-Visual-Composer
...
function ahvc_register_scripts() {
  ...
  wp_register_style( 'ahvc_animation_css', plugins_url( '/assets/public/css/heading_animation.css', __FILE__ ), array(), time(), false );
  wp_register_script( 'ahvc_animation_js', plugins_url( '/assets/public/js/animated_heading_vc.js', __FILE__ ), array('jquery'), time(), true );
